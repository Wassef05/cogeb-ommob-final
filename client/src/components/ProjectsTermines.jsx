...
const TermineeProjects = () => {
    ...
    const { t } = useTranslation(); // Utiliser useTranslation pour récupérer les traductions
            ...
            <div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-16 lg:px-8">
                <div className="content">
                    <h2 className="text-xl sm:text-3xl font-bold text-[#515557] sm:text-left">
                        {t('projects.realizedProjects')} {/* Traduction du titre */}
                    </h2>
                </div>
                            ...
                            <div className="text-center pt-6">
                                ...
                                >
                                    ...
                                    <span className="text-xl transition-all group-hover:me-6">
                                        {t('projects.viewMore')} {/* Traduction du bouton */}
                                    </span>
                                </button>
                            </div>
                        </div>
